  ...
  function (e, t, n) {
    ...
    !(function () {
      ...
      function n() {
        ...
        return (
          t >= 55 && !!n && "cellular" === n.type && n.downlinkMax <= 0.115
        );
      }
      function s(e) {
      ...
      !(function () {
        function f() {
          ...
          try {
            n =
              "function" == typeof l.getEntriesByType
                ? new URL(l.getEntriesByType("navigation")[0].name).pathname
                : b
                ? new URL(b).pathname
          ...
          return (
            g &&
              (g.version && (r.versions.fl = g.version),
              g.icTag && (r.icTag = g.icTag),
              (r.siteToken = g.token)),
            C &&
              ((r.lcp = C.lcp && void 0 !== C.lcp.value ? C.lcp : r.lcp),
        ...
        function d(r) {
          var o = l.timing,
            ...
            p = {
              ...
              versions: { fl: g ? g.version : "", js: "2021.12.0", timings: 1 },
              pageloadId: v,
              location: c,
            };
          if (void 0 == E) {
          ...
          if (
            ...
            h.forEach(function (e) {
              ...
              p.tempResources &&
                void 0 === p.tempResources[T] &&
                (p.tempResources[T] = []);
              var n = JSON.stringify(t).length;
              w + n < 62e3 && p.tempResources
                ? ((w += n), p.tempResources[T].push(t))
                : (T++, (w = 0));
            });
          }
          return (
            JSON.stringify(p).length >= 64e3 && (p.resources = []),
            void 0 !== E &&
              (delete p.timings,
              delete p.memory,
              delete p.errorCount,
        ...
        if (!g || "single" !== g.load) {
          ...
          if (l && g && g.token) {
            ...
            var C = { lcp: void 0, cls: void 0, fid: void 0 },
              O = function (e) {
                ...
                if (t && t.sources && t.sources.length) {
                  var n = t.sources.reduce(function (e, t) {
                    return e.node &&
                      e.previousRect.width * e.previousRect.height >
                        t.previousRect.width * t.previousRect.height
                      ? e
                      : t;
                  });
                  if (n) return n;
              ...
              P = function (e) {
                ...
                var t = e.localName;
                return (
                  e.id && e.id.length > 0 && (t += "#" + e.id),
                  e.className &&
                    e.className.length > 0 &&
                    (t += "." + e.className.split(" ").join(".")),
                  t
                );
              },
              B = function (e) {
                ...
                if ("CLS" === e.name) {
                  C.cls = { value: e.value, path: t };
                  var n = O(e.entries);
                  n &&
                    ((C.cls.element = P(n.node)),
                    (C.cls.currentRect = n.currentRect),
                    (C.cls.previousRect = n.previousRect));
                } else if ("FID" === e.name) {
                  C.fid = { value: e.value, path: t };
                  var n = _(e.entries);
                  n && ((C.fid.element = P(n.target)), (C.fid.name = n.name));
                } else if ("LCP" === e.name) {
                  C.lcp = { value: e.value, path: t };
                  var n = _(e.entries);
                  n &&
                    ((C.lcp.element = P(n.element)),
                    (C.lcp.size = n.size),
                    (C.lcp.url = n.url));
                }
              };
            ...
            var k = g && (void 0 === g.spa || !0 === g.spa),
                ...
                var t = function (e, t) {
                    (n.resources = e),
                      ...
                      g &&
                        ...
                        k &&
                          0 === t &&
                          (m.push({ id: n.pageloadId, url: n.location }),
                          m.length > 3 && m.shift()),
                        (0, o.sendObjectBeacon)("", n, function () {}, !1, A),
                        void 0 !== g.forward &&
                          void 0 !== g.forward.url &&
              ...
              F = function (e) {
                var t = f();
                e || ((t.resources = []), delete t.tempResources),
                  g && (0, o.sendObjectBeacon)("", t, function () {}, !0, A);
              },
              I = function () {
                R = !0;
                var e =
    ...
    var r,
      ...
      _ = function (e, t) {
        ...
        if (a) {
          ...
          var l = function () {
            O.has(i.id) ||
              (a.takeRecords().map(o), a.disconnect(), O.add(i.id), n(!0));
          };
